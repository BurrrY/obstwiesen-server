...
var history = [...]string{
	...
	"CREATE TABLE `varieties` ( `id` VARCHAR(21) NOT NULL, `name` VARCHAR(200) NOT NULL, `parent` VARCHAR(21) NULL, PRIMARY KEY (`id`) );",
	"ALTER TABLE `trees` ADD COLUMN `variety` VARCHAR(21) NULL DEFAULT NULL, ADD CONSTRAINT `FK_trees_varieties` FOREIGN KEY (`variety`) REFERENCES `varieties` (`id`);",
}
